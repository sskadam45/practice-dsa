    ...
    <nav className='relative flex h-[50px] w-full shrink-0 items-center px-5 bg-dark-layer-1 text-dark-gray-7'>
			<div className={`flex w-full items-center justify-between ${!props.problemPage ? "max-w-[1200px] mx-auto" : ""}`}>
				<Link href='/' className='h-[22px] flex-1'>
					<img src='/signin-logo.jpg' alt='Logo' height={100} width={100} />
				</Link>
				{props.problemPage && (
					<div className='flex items-center gap-4 flex-1 justify-center'> 
						<div className='flex items-center justify-center rounded bg-dark-fill-2 hover:bg-dark-fill-3
				...
				<div className='flex items-center space-x-4 flex-1 justify-end'>
                    ...
                    {user && (
                        <div className='cursor-pointer group relative'>
                            <Image src="/favicon.ico" alt='Avatar' width={30} height={30} className='rounded-full' />
                            <div
